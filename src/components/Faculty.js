            ...
            <div className="application-box" onClick={this.clickRow.bind(this)}>
                <div className="row opp-box-row">
                    ...
                    <div className="column column-90">
                        ...
                        <div>{this.props.researchDescription && this.props.researchDescription.length > 0 ? this.convertDescription(this.props.researchDescription)
                    : this.convertDescription(this.props.bio)}</div>
