...
class FacultyList extends Component {
  ...
  render() {
    const profNodes = this.props.data.map((prof) => {
      ...
      const departmentSelected = filteredOptions.department;
      const areaSelected = filteredOptions.area;
    ...
    const nodeCount = this.countNodes(profNodes);
    return (
      <div>
