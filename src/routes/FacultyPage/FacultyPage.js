            ...
            <div>
                ...
                <div className="container">
                    ...
                    <div className="title-box prof-box">
                        <div className="row">
                            ...
                            <div className="column column-75">
                                ...
                                <p><b>Areas of
                                    Interest: </b>{(this.state.profInfo.researchInterests && this.state.profInfo.researchInterests.length !== 0) ?
                                    this.separateInterests(this.state.profInfo.researchInterests) : "None found"}</p>
                                <div className="row">
                                    <div className="column column-60">
                                        <h6>
                                            Office: {this.state.profInfo.office ? this.state.profInfo.office : "Unknown"}</h6>
                                    </div>


                                    <div className="column column-60">
                                        <h6>Email: <a
                                            href={this.state.profInfo.email ? "mailto:" + this.state.profInfo.email : ""}>{this.state.profInfo.email ? this.state.profInfo.email : "Unknown"}</a>
                                        </h6>
                                    </div>
                                </div>
                                <div className="row">
                                    <div className="column column-60">
                                        <h6>
                                            Phone: {this.state.profInfo.phone ? this.state.profInfo.phone : "Unknown"} </h6>
                                    </div>
                                    ...
                                    <div className="column column-60">
                                        <h6>Website: <b><a
                                            ...
                                            target="_blank">{this.state.profInfo.labPage ? "View page" : "None"}</a></b>
                                        </h6>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="prof-box">
                        <h3>About</h3>
                        <p>{this.state.profInfo.researchDescription && this.state.profInfo.researchDescription.length > 0 ?
                            this.state.profInfo.researchDescription : "No description provided"}</p>
                        <br />
                        <h3>Bio</h3>
                        <p>{this.state.profInfo.bio && this.state.profInfo.bio.length > 0 ? this.state.profInfo.bio :
                            "No bio provided"}</p>
                    </div>
