                ...
                <div className="row">
                  <div className="opp-details-card">
                    <div className="opp-details-section">
                      ...
                      <p className="instructions">One way to find interesting research is by going to the <a href="/faculty">"View Opportunities" </a>
                      ...
                      to accept undergrads that semester and are doing research that piques your interest.</p>
