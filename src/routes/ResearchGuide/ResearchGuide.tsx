                ...
                <div className="opp-details-card">
                  <div className="opp-details-section">
                    ...
                    <p className="instructions">
                      ...
                      {' page and finding opportunities in an area that\'s interesting to you.'}
                  ...
                  <div className="opp-details-section">
                    ...
                    <p className="instructions">
                      {'It can\'t hurt; worst case scenario they tell you to ping them in a month'}
                      {'or so and now you\'ve demonstrated interest!'}
                    </p>
                  </div>
                  <div className="opp-details-section">
                    ...
                    <p className="substep">
                      ...
                      <a
                        href="https://medium.com/@researchconnectcu/cornell-cs-research-readme-381206eaabcb"
                        target="_blank"
                        rel="noopener noreferrer"
                      >
                        comprehensive guide
